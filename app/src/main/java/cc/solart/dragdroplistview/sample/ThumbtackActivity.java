...
import cc.solart.dragdroplistview.sample.adapter.ThumbtackTileAdapter;
import cc.solart.dragdroplistview.sample.model.SimpleDragEntity;


public class ThumbtackActivity extends AppCompatActivity implements AbsTileAdapter.DragDropListener {

    DragDropListView mListView;
    ThumbtackTileAdapter mThumbtackTileAdapter;
